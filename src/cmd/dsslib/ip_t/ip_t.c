...
static const char id[] = "\n@(#)$Id: dss ip type library (AT&T Research) 2008-07-25 $\0\n";
...
#define IPV4ADDR_T	(&types[8])
#define IPV6ADDR_T	(&types[9])
#define IPV4PREFIX_T	(&types[11])
#define IPV6PREFIX_T	(&types[12])
