...
"[-?\n@(#)sum (AT&T Labs Research) 1999-11-11\n]"
USAGE_LICENSE
...
"	\b--header\b should be used when the output is to be checked so the"
"	checksum method can be automatically determined. The listed checksum is"
...
"	that is checksummed.]"
"[p:permissions?If \b--check\b=\afile\a is not specified then list the file"
"	mode, user and group between the checksum and path. User and group"
"	matching the caller are output as \b-\b. If \b--check\b=\afile\a is"
