...
"	were updates.]"
"[R:regenerate?If index files are required then \b--regenerate\b forces them"
"	to be regenerated even if the otherwise seem up-to-date.]"
...
main(int argc, char** argv)
{
	...
	if (p = state.edge)
	{
		...
		{
			*e = 0;
			state.closure.relation = closure.relation = (Exid_t*)dtmatch(prog->symbols, parent->name);
			*e = '.';
