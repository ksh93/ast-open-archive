...
#define pax_vdb_next		(&pax_zip_format)
#define pax_zip_next		(&pax_cab_format)
#define pax_cab_next		(&pax_rpm_format)
#define pax_rpm_next		(&pax_mime_format)
#define pax_mime_next		(&pax_tnef_format)
#define pax_tnef_next		(&pax_pds_format)
#define pax_pds_next		(&pax_calib_format)
#define pax_calib_next		(&pax_compress_format)
...
extern Format_t			pax_cab_format;
extern Format_t			pax_calib_format;
...
extern Format_t			pax_zip_format;
