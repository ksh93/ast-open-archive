...
"[+DESCRIPTION?In the simplest case, \bdiff\b compares the contents of the"
"	two files \afrom-file\a and \ato-file\a. A file name of \b-\b stands"
"	for text read from the standard input. As a special case, \bdiff - -\b"
"	compares a copy of standard input to itself.]"
"[+?If \afrom-file\a is a directory and \ato-file\a is not, \bdiff\b compares"
"	the file in \afrom-file\a whose file name is that of \ato-file\a, and"
"	vice versa. The non-directory file must not be \b-\b.]"
"[+?If both \afrom-file\a and \ato-file\a are directories, \bdiff\b compares"
"	corresponding files in both directories, in alphabetical order; this"
"	comparison is not recursive unless the \b--recursive\b option is"
"	given. \bdiff\b never compares the actual contents of a directory as"
"	if it were a file. The file that is fully specified may not be"
"	standard input, because standard input is nameless and the notion of"
"	``file with the same name'' does not apply.]"

"[B:ignore-blank-lines?Ignore changes that just insert or delete blank lines.]"
"[C:context?Use the context output format, showing \alines\a lines of"
"	context. For proper operation, \bpatch\b(1) typically needs at least"
"	2 lines of context.]#[lines:=3]"
"[D:ifdef?Make merged \aif-then-else\a format output, conditional on the"
"	preprocessor macro \amacro\a.]:[macro]"
"[F:show-function-line?In context and unified format, for each hunk of"
"	differences, show some of the last preceding line that matches"
"	the regular expression \apattern\a.]:[pattern]"
"[H:speed-large-files?Use heuristics to speed handling of large files that"
"	have numerous scattered small changes.]"
"[I:ignore-matching-lines?Ignore changes that just insert or delete lines"
"	that match the regular expression \apattern\a.]:[pattern]"
"[L:label|file-label?Use \alabel\a instead of the file name in the context"
"	format and unified format headers.]:[label]"
"[N:new-file|entire-new-file?In directory comparison, if a file is found in"
"	only one directory, treat it as present but empty in the other"
"	directory.]"
"[P:unidirectional-new-file?When comparing directories, if a file appears"
"	only in the second directory of the two, treat it as present but"
"	empty in the other.]"
"[S:starting-file?When comparing directories, start with the file"
"	\afile\a. This is for resuming an interrupted comparison.]:[file]"
"[T:initial-tab?Output a tab rather than a space before the text of a line in"
"	normal or context format. This causes the alignment of tabs in the"
"	line to look normal.]"
"[W:width?Use an output width of \acolumns\a in side by side format.]#[columns]"
"[a:text|ascii?Treat all files as text and compare them line-by-line, even if"
...
"	This makes \bdiff\b slower (sometimes \amuch\a slower).]"
"[e:ed?Make output that is a valid \bed\b(1) script.]"
"[f:forward-ed?Make output that looks vaguely like an \bed\b(1) script but has"
"	changes in the order they appear in the file.]"
"[i:ignore-case?Ignore changes in case; consider upper- and lower-case letters"
"	equivalent.]"
"[l:paginate|print?Pass the output through \bpr\b(1) to paginate it.]"
"[n:rcs?Output \brcs\b(1) format diffs; like \b--forward-ed\b except that"
"	each command specifies the number of lines affected.]"
"[p:show-c-function?Show which C function each change is in.]"
"[q:brief?Report only whether the files differ, not the details of the"
"	differences.]"
"[r:recursive?When comparing directories, recursively compare any"
"	subdirectories found.]"
"[s:report-identical-files?Report when two files are the same.]"
"[t:expand-tabs?Expand tabs to spaces in the output, to preserve the alignment"
"	of tabs in the input files.]"
"[w:ignore-all-space?Ignore white space when comparing lines.]"
"[x:exclude?When comparing directories, ignore files and subdirectories whose"
"	basenames match the \bsh\b(1) file match \apattern\a.]:[pattern]"
"[X:exclude-from?When comparing directories, ignore files and subdirectories"
"	whose basenames match any pattern contained in \afile\a, where each"
"	is taken to be one \bsh\b(1) file match pattern.]:[file]"
"[y:side-by-side?Use the side by side output format.]"
"[U:unified?Use the unified output format, showing \alines\a lines of"
"	context. For proper operation \bpatch\b(1) typically needs at least"
"	2 lines of context.]#?[lines:=3]"
"[129:left-column?Print only the left column of two common lines in side by"
"	side format.]"
"[130:suppress-common-lines?Do not print common lines in side by side format.]"
"[131:sdiff-merge-assist?Print extra information to help \bsdiff\b(1)."
"	Not intended for other use besides \bsdiff\b.]"
"[132:old-line-format?Use \aformat\a to output a line taken from just the"
"	first file in \aif-then-else\a format.]:[format]"
"[133:new-line-format?Use \aformat\a to output a line taken from just the"
"	second file in \aif-then-else\a format.]:[format]"
"[134:unchanged-line-format?Use \aformat\a to output a line common to both"
"	files in \aif-then-else\a format.]:[format]"
"[135:line-format?Use \aformat\a to output all input lines in \aif-then-else\a"
"	format.]:[format]"
"[136:old-group-format?Use \aformat\a to output a group of lines taken from"
"	just the first file in \aif-then-else\a format.]:[format]"
"[137:new-group-format?Use \aformat\a to output a group of lines taken from"
"	just the second file in \aif-then-else\a format.]:[format]"
"[138:unchanged-group-format?Use \aformat\a to output a group of common lines"
"	taken from both files in if-then-else format.]:[format]"
"[139:changed-group-format?Use \aformat\a to output a line group containing"
"	differing lines from both files in if-then-else format.]:[format]"
"[140:horizon-lines?Do not discard the last \alines\a lines of the common"
"	prefix and the first \alines\a lines of the common suffix.]#[lines]"
"[142:binary?Read and write data in binary mode. Ignored on some systems.]"
"[c:?Equivalent to \b--context=3\b.]"
"[h:?Ignored by this implementation.]"
"[u:?Equivalent to \b--unified=3\b.]"
...
"	[+2?An error occurred.]"
"}"
"[+SEE ALSO?\bcmp\b(1), \bcomm\b(1), \bdiff3\b(1), \bed\b(1), \bpatch\b(1),"
"	\bpr\b(1), \bsdiff\b(1)]"
;
     ...
     char const *pattern;
{
  ...
  if (m != 0)
  {
    regerror (m, &r->buf, msg, sizeof(msg));
    error ("%s: %s", pattern, msg);
  }
