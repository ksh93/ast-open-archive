...
USAGE_LICENSE
#endif
"[+NAME?sdiff - find differences between two files and merge interactively]"
"[+DESCRIPTION?The \bsdiff\b command merges two files and interactively"
"	outputs the results.]"
"[+?If \afrom-file\a is a directory and \ato-file\a is not, \bsdiff\b"
"	compares the file in \afrom-file\a whose file name is that of"
"	\ato-file\a, and vice versa. \afrom-file\a and \ato-file\a may not"
"	both be directories.]"
"[+?\bsdiff\b without \b--output\b produces a side-by-side difference. This"
"	usage is obsolete; use \bdiff --side-by-side\b instead.]"

"[o:output?Output interactively, sending output to \afile\a. This option"
"	is required for merging.]:[file]"
"[a:text|ascii:?Treat all files as text and compare them line-by-line,"
"	even if they do not appear to be text.]"
"[i:ignore-case?Consider upper- and lower-case to be the same.]"
"[W:ignore-all-space?Ignore all white space. For historical reasons this"
"	option is \b-w\b in \bdiff\b(1).]"
"[b:ignore-space-change?Ignore changes in the amount of white space.]"
"[B:ignore-blank-lines?Ignore changes whose lines are all blank.]"
"[I:ignore-matching-lines?Ignore changes whose lines all match the"
"	regular expression \apattern\a.]:[pattern]"
"[w:width?Output at most \acolumns\a 130) characters per line. For historical"
"	reasons this option is \b-w\b in \bdiff\b(1).]#[columns:=130]"
...
"	[+2?An error occurred.]"
"}"
"[+SEE ALSO?\bcmp\b(1), \bcomm\b(1), \bdiff\b(1), \bdiff3\b(1), \bed\b(1),"
"	\bpatch\b(1)]"
;
...
#if _PACKAGE_ast
  error_info.id = "diff";
  while ((opt = optget(argv, ast_usage)) && opt < 0 ? (opt = -opt) : opt)
#else
